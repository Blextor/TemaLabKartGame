...
{
    public class RoadSideMeshCreatorB : PathSceneTool
    {
        ...
        {
            meshHolder = GameObject.Find("Road Side Mesh HolderB");
            if (meshHolder != null)
            {
            ...
            if (meshHolder == null)
            {
                meshHolder = new GameObject("Road Side Mesh HolderB");
