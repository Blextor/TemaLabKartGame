...
{
    public class InvisibleSideMeshCreatorB : PathSceneTool
    {
        ...
        {
            meshHolder = GameObject.Find("Invisible Side Mesh HolderB");
            if (meshHolder != null)
            {
            ...
            if (meshHolder == null)
            {
                meshHolder = new GameObject("Invisible Side Mesh HolderB");
