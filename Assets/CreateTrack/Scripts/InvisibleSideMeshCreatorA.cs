...
{
    public class InvisibleSideMeshCreatorA : PathSceneTool
    {
        ...
        {
            meshHolder = GameObject.Find("Invisible Side Mesh HolderA");
            if (meshHolder != null)
            {
            ...
            if (meshHolder == null)
            {
                meshHolder = new GameObject("Invisible Side Mesh HolderA");
                // meshHolder.transform.parent = GameObject.Find("RoadSideCreator").transform;
            }
