...
{
    public class F1_Physics : MonoBehaviour
    {
        [System.Serializable]
        public class StatPowerup
        {
            public F1_Physics.Stats modifiers;
        ...
        public F1_Physics.Stats baseStats = new F1_Physics.Stats
        {
            TopSpeed = 10f,
            Acceleration = 5f,
