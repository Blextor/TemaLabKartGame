...
namespace Unity.Netcode.Components
{
    ...
    public class NetworkTransform2 : NetworkBehaviour
    {
        ...
        private BufferedLinearInterpolator2<float> m_PositionXInterpolator; // = new BufferedLinearInterpolatorFloat();
        private BufferedLinearInterpolator2<float> m_PositionYInterpolator; // = new BufferedLinearInterpolatorFloat();
        private BufferedLinearInterpolator2<float> m_PositionZInterpolator; // = new BufferedLinearInterpolatorFloat();
        private BufferedLinearInterpolator2<Quaternion> m_RotationInterpolator; // = new BufferedLinearInterpolatorQuaternion(); // rotation is a single Quaternion since each euler axis will affect the quaternion's final value
        private BufferedLinearInterpolator2<float> m_ScaleXInterpolator; // = new BufferedLinearInterpolatorFloat();
        private BufferedLinearInterpolator2<float> m_ScaleYInterpolator; // = new BufferedLinearInterpolatorFloat();
        private BufferedLinearInterpolator2<float> m_ScaleZInterpolator; // = new BufferedLinearInterpolatorFloat();
        private readonly List<BufferedLinearInterpolator2<float>> m_AllFloatInterpolators = new List<BufferedLinearInterpolator2<float>>(6);
        ...
        private void Awake()
        {
            ...
            m_PositionXInterpolator = new BufferedLinearInterpolatorFloat2();
            m_PositionYInterpolator = new BufferedLinearInterpolatorFloat2();
            m_PositionZInterpolator = new BufferedLinearInterpolatorFloat2();
            m_RotationInterpolator = new BufferedLinearInterpolatorQuaternion2(); // rotation is a single Quaternion since each euler axis will affect the quaternion's final value
            m_ScaleXInterpolator = new BufferedLinearInterpolatorFloat2();
            m_ScaleYInterpolator = new BufferedLinearInterpolatorFloat2();
            m_ScaleZInterpolator = new BufferedLinearInterpolatorFloat2();
