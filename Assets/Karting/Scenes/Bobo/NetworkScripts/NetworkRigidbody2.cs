...
[RequireComponent(typeof(Rigidbody))]
    [RequireComponent(typeof(NetworkTransform2))]
    public class NetworkRigidbody2 : NetworkBehaviour
    {
        private Rigidbody m_Rigidbody;
        private NetworkTransform2 m_NetworkTransform;
        ...
        private void Awake()
        {
            ...
            m_NetworkTransform = GetComponent<NetworkTransform2>();
        }
