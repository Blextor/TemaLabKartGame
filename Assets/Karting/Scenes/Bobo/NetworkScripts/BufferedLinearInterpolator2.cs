...
namespace Unity.Netcode
{
    ...
    internal abstract class BufferedLinearInterpolator2<T> where T : struct
    {
    ...
    internal class BufferedLinearInterpolatorFloat2 : BufferedLinearInterpolator2<float>
    {
    ...
    internal class BufferedLinearInterpolatorQuaternion2 : BufferedLinearInterpolator2<Quaternion>
    {
